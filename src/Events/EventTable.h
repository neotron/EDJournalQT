...
namespace Journal {
    QMap<QString, Event::JournalEvent>
        Event::s_eventLookupMap = {{ "fileheader",            Event::FileHeader },
                                   ...
                                   { "squadronstartup",       Event::SquadronStartup },
                                   { "fsssignaldiscovered",   Event::FSSSignalDiscovered },
                                   { "fsdtarget",             Event::FSDTarget },
                                   { "fssdiscoveryscan",      Event::FSSDiscoveryScan },
                                   { "fssallbodiesfound",     Event::FSSAllBodiesFound },
                                   { "reservoirreplenished",  Event::ReservoirReplenished },
                                   { "saascancomplete",       Event::SAAScanComplete },
                                   { "status",                Event::Status },
    };
}
